...
6. Salin Project URL dan anon key ke `.env.local`:
...
7. Restart dev server Vite.
8. Buat user di Supabase Authentication, lalu isi row `profiles` dengan `id` yang sama dengan `auth.users.id`.
